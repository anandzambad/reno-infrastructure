...
CREATE USER IF NOT EXISTS 'reno_app'@'127.0.0.1' IDENTIFIED BY 'REPLACE_WITH_STRONG_PASSWORD';
ALTER USER 'reno_app'@'127.0.0.1' IDENTIFIED BY 'REPLACE_WITH_STRONG_PASSWORD';
GRANT ALL PRIVILEGES ON `reno`.* TO 'reno_app'@'127.0.0.1';
FLUSH PRIVILEGES;
